...
<template>
  <NLayout has-sider class="min-h-[100dvh] bg-slate-100">
    <NLayoutSider bordered collapse-mode="width" :collapsed-width="84" :width="248" class="!bg-slate-950">
      <div class="px-6 pt-7 pb-6">
        <span class="mb-2 inline-block text-[0.78rem] uppercase tracking-[0.16em] text-blue-200/80">CipherSubmit</span>
    ...
    <NLayout class="min-h-[100dvh] bg-slate-100">
      <NLayoutHeader bordered class="sticky top-0 z-10 flex min-h-[88px] flex-col items-start justify-between gap-5 border-b border-slate-200/80 bg-white/92 px-4 py-5 backdrop-blur md:flex-row md:items-center md:px-7">
        <div>
          <p class="mb-2 inline-block text-[0.78rem] uppercase tracking-[0.16em] text-slate-500">Operations</p>
